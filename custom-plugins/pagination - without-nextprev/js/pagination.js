...
/*=========================Create pagination==============================*/
			if(objSettings.show_next_prev)
				...
				$(objSettings.Mainwrapper+' .'+objSettings.pagination).html('<ul>'+paginationdata+'</ul>');
			
/*=========================Attach first,last links=========================*/
			if(objSettings.show_first_last_links)
			{
...
/*=========================Attach disable links=========================*/
			...
			if(objSettings.show_disable_links)
			{
				if(objSettings.show_next_prev)
				{
					...
					{
						$(objSettings.Mainwrapper+' .'+objSettings.pagination).prepend('<span class="'+objSettings.Previous+'disable">Previous</span>');
						$(objSettings.Mainwrapper+' .'+objSettings.pagination).append('<span style="display:none;" class="'+objSettings.Next+'disable">Next</span>');
					}
				}
				else
				{
					if(objSettings.show_first_last_links)
					{
						$(objSettings.Mainwrapper+' .'+objSettings.pagination).prepend('<span class="'+objSettings.First_Link+'disable">First</span>');
						$(objSettings.Mainwrapper+' .'+objSettings.pagination).append('<span class="'+objSettings.Last_Link+'disable" style="display:none;">Last</span>');
					}
				}
			}
	...
	/*=========================Show/hide according li=======================*/
					...
					if(cnt<objSettings.number_of_middle_button)
					{
						...
						if(last_li_index>objSettings.number_of_middle_button)
						{
							...
							if(objSettnings.show_first_last_links)
