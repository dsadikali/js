...
function et_eC(param)
{
	...
	{
		et_gp+='&et_pagename=' + encodeURIComponent(et_pagename.substr(0, et_maxValueLength));
		et_easy = 0;
	}
	...
	if(et_areas!='')
		et_gp +='&et_areas=' + encodeURIComponent(et_areas.substr(0, et_maxValueLength));
	...
	et_gp += '&'+'et_target=' + encodeURIComponent( et_tt.length ? et_tt : et_target ) +',' + ( et_tv ? et_tv: et_tval ) + ',' + ( et_to ? et_to : et_tonr )+ ','+(et_ts ? et_ts : et_tsale )+','+( typeof( et_cust ) == 'number' ? et_cust : 0 );
	...
	if(et_basket!='')
		et_gp += '&et_basket=' + encodeURIComponent(et_basket); 
	...
	else
	{
		...
		et_gp += '&et_url='+encodeURIComponent( et[0] );
	}
	...
	if(typeof(et_pl) != 'undefined' && typeof(et_pl) != 'unknown' && et_pl!='' ) 
		et_gp +='&p='+encodeURIComponent(et_pl);
...
function et_eC_Wrapper( param,et_pn,et_ar,et_il,et_ur,et_ta,et_tv,et_to,et_ts,et_cu,et_ba,et_lp,et_tr,et_tg,et_sb)
{
    ...
    if(!param.length)
	{
		et_pagename     = param.et_pagename     ? encodeURIComponent(param.et_pagename)     : '';
		et_areas        = param.et_areas        ? encodeURIComponent(param.et_areas)        : '';
		et_ilevel       = param.et_ilevel       ? encodeURIComponent(param.et_ilevel)       : 0; 
		et_url          = param.et_url          ? encodeURIComponent(param.et_url)          : '';
		et_target       = param.et_target       ? encodeURIComponent(param.et_target)       : '';
		et_tval         = param.et_tval         ? encodeURIComponent(param.et_tval)         : '';
		et_tonr         = param.et_tonr         ? encodeURIComponent(param.et_tonr)         : ''; 
		et_tsale        = param.et_tsale        ? encodeURIComponent(param.et_tsale)        : 0;
		et_cust         = (param.et_cust && typeof(param.et_cust) == 'number') ? param.et_cust : 0;
		et_basket       = param.et_basket       ? encodeURIComponent(param.et_basket)       : ''; 
		et_lpage        = param.et_lpage        ? encodeURIComponent(param.et_lpage)        : '';
		et_trig         = param.et_trigger      ? encodeURIComponent(param.et_trigger)      : '';
		et_tag          = param.et_tag          ? encodeURIComponent(param.et_tag)          : '';
		et_organisation = param.et_organisation ? encodeURIComponent(param.et_organisation) : '';
		et_demographic  = param.et_demographic  ? encodeURIComponent(param.et_demographic)  : '';
        et_sub          = param.et_sub          ? encodeURIComponent(param.et_sub)          : '';
	...
	else
	{
		...
		et_pagename     = et_pn ? encodeURIComponent(et_pn): '';
		et_areas        = et_ar ? encodeURIComponent(et_ar) : '';
		et_ilevel       = et_il ? encodeURIComponent(et_il) : 0; 
		et_url          = et_ur ? encodeURIComponent(et_ur) : '';
		et_target       = et_ta ? encodeURIComponent(et_ta) : '';
		et_tval         = et_tv ? encodeURIComponent(et_tv) : '';
		et_tonr         = et_to ? encodeURIComponent(et_to) : ''; 
		et_tsale        = et_ts ? encodeURIComponent(et_ts) : 0;
		et_cust         = et_cu ? et_cu : 0;
		et_basket       = et_ba ? encodeURIComponent(et_ba) : ''; 
		et_lpage        = et_lp ? encodeURIComponent(et_lp) : '';
		et_trig         = et_tr ? encodeURIComponent(et_tr) : '';
		et_tag          = et_tg ? encodeURIComponent(et_tg) : '';
        et_sub          = et_sb ? encodeURIComponent(et_sb) : '';
...
function et_sendData( a, n, c, p, x, y, s, t )
{
	...
	var oh = encodeURIComponent(domain + et_spPage(window.location.pathname) + et_spPage(s));
	...
	par = 'et='+et_et+'&n='+oh+'&i='+encodeURIComponent(pagename)+'&easy='+easy+'&p='+p+'&m='+m+'&h='+et_divHash(n)+'&c='+et_divHash(c)+'&x='+x+'&y='+y+'&t='+t;
...
function etEvent(secure,host) 
{
	...
	var sendEvent = function(object)
	{
		...
		if(object.category)
			et_parameters += '&et_cat=' + encodeURIComponent(object.category); 

		if(object.item)
			et_parameters += '&et_item=' + encodeURIComponent(object.item); 

		if(object.action)
			et_parameters += '&et_action=' + encodeURIComponent(object.action); 

		if(object.tags)
			et_parameters += '&et_tags=' + encodeURIComponent(object.tags); 

		if(object.value)
			et_parameters += '&et_value=' + encodeURIComponent(object.value); 

		if(typeof(et_pagename) != 'undefined' && typeof(et_pagename) != 'unknown')
		{
			et_parameters += '&et_pagename=' + encodeURIComponent(et_pagename);
		...
		else
		{
			...
			et_parameters += '&et_url='+encodeURIComponent(et[0]);
		}
		...
		et_parameters += '&scolor=' + encodeURIComponent(et_sc);
		et_parameters += '&swidth=' + encodeURIComponent(et_sw);
...
function et_iO()
{
	...
	else if((et_location.match(/.et_overlay=1/gi))||(et_d.cookie.match(/et_overlay=1/))||(et_d.cookie.match(/et_overlay=2/)))
	{
		...
		var url = et_host+'et_overlay_show.php'+'?et='+et_et+'&n='+encodeURIComponent(et_thisHref)+'&i='+encodeURIComponent(pagename)+'&easy='+easy+'&o=' + et_overlay + et_liveSwitch +'&t='+new Date().getTime(); 
...
ET_Event = new etEvent('Zl308K', et_server);
function _etc()
{
	var c = "";
